...
//		dep_current_esk(spec->part[i].ix, spec->part[i].iy, di, dj, spec->part[i].x, spec->part[i].y, x1, y1, qnx, qny,
//				qvz, current);

		dep_current_zamb(spec->part[i].ix, spec->part[i].iy, di, dj, spec->part[i].x, spec->part[i].y, dx, dy, qnx, qny,
				qvz, current);
