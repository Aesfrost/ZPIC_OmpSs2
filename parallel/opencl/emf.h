...
void emf_move_window(t_vfld *restrict E, t_vfld *restrict B, const int nrow, const int nx[0], const int gc[2][2], const int total_size);
void emf_update_gc(t_vfld *restrict E, t_vfld *restrict B, const int nrow, const int nx[2],
