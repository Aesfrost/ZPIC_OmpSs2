...
void spec_update_main_vector(t_species *spec)
{
	...
	if (spec->main_vector.size + np_inj > spec->main_vector.size_max)
	{
		...
		realloc_buffer((void **) &spec->main_vector.part, spec->main_vector.size, spec->main_vector.size_max,
								sizeof(t_part));
	}
	...
	switch (vector->type)
	{
		case AoS:
			if (vector->size + 1 > vector->size_max)
			{
				...
				realloc_buffer((void **) &vector->part, vector->size, vector->size_max, sizeof(t_part));
			}
		...
		case SoA:
			if (vector->size + 1 > vector->size_max)
			{
				...
				realloc_buffer((void **) &vector->x, vector->size, vector->size_max, sizeof(t_fld));
				realloc_buffer((void **) &vector->y, vector->size, vector->size_max, sizeof(t_fld));
				realloc_buffer((void **) &vector->ux, vector->size, vector->size_max, sizeof(t_fld));
				realloc_buffer((void **) &vector->uy, vector->size, vector->size_max, sizeof(t_fld));
				realloc_buffer((void **) &vector->uz, vector->size, vector->size_max, sizeof(t_fld));
				realloc_buffer((void **) &vector->safe_to_delete, vector->size, vector->size_max, sizeof(bool));
			}
	...
	if (spec->main_vector.size + np_inj > spec->main_vector.size_max)
	{
		...
		switch (spec->main_vector.type)
		{
			case AoS:
				...
				break;
			case SoA:
				realloc_buffer((void **) &spec->main_vector.ix, spec->main_vector.size, spec->main_vector.size_max,
										sizeof(int));
				realloc_buffer((void **) &spec->main_vector.iy, spec->main_vector.size, spec->main_vector.size_max,
										sizeof(int));
				realloc_buffer((void **) &spec->main_vector.x, spec->main_vector.size, spec->main_vector.size_max,
										sizeof(t_fld));
				realloc_buffer((void **) &spec->main_vector.y, spec->main_vector.size, spec->main_vector.size_max,
										sizeof(t_fld));
				realloc_buffer((void **) &spec->main_vector.ux, spec->main_vector.size, spec->main_vector.size_max,
										sizeof(t_fld));
				realloc_buffer((void **) &spec->main_vector.uy, spec->main_vector.size, spec->main_vector.size_max,
										sizeof(t_fld));
				realloc_buffer((void **) &spec->main_vector.uz, spec->main_vector.size, spec->main_vector.size_max,
										sizeof(t_fld));
				realloc_buffer((void **) &spec->main_vector.safe_to_delete, spec->main_vector.size,
										spec->main_vector.size_max, sizeof(bool));
				break;
		}
	}
		...
		const float dt, t_density *density, const int region_size)
{
	...
	spec->main_vector.part = (t_part*) malloc(spec->main_vector.size_max * sizeof(t_part));
	...
	for (i = 0; i < 2; i++)
	{
		...
		spec->temp_buffer[i].part = (t_part*) malloc(spec->temp_buffer[i].size_max * sizeof(t_part));
