...
#define MAX_LEAVING_PART 0.2 // Percentage of the total number of particles
#define NP_MULTIPLY 1.1
...
// OpenCL Kernels
#ifdef TARGET_GPU
#pragma omp target device(opencl) copy_deps ndrange(2, n_tiles.x * WORK_ITENS, n_tiles.y, WORK_ITENS, 1) file(kernel_gpu.cl)
...
#pragma omp target device(opencl) copy_deps ndrange(1, np_inj, WORK_ITENS) file(kernel_gpu.cl)
...
#pragma omp target device(opencl) copy_deps ndrange(1, WORK_ITENS * n_tiles.x * n_tiles.y, WORK_ITENS) file(kernel_gpu.cl)
