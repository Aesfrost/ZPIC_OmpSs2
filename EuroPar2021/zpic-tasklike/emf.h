...
// CPU Tasks
//#pragma omp task in(current->J_buf[0: current->total_size]) \
//depend(inout : emf->E_buf[0: emf->total_size]) \
//depend(inout : emf->B_buf[0: emf->total_size]) \
//label(EMF Advance)
void emf_advance(t_emf *emf, const t_current *current);

//#pragma omp task depend(inout : emf->B_buf[0: emf->overlap]) \
//depend(inout : emf->B_upper[-emf->gc[0][0]: emf->overlap]) \
//depend(inout : emf->E_buf[0: emf->overlap]) \
//depend(inout : emf->E_upper[-emf->gc[0][0]: emf->overlap]) \
//label(EMF Update GC)
